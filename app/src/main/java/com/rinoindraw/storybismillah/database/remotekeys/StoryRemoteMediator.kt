package com.rinoindraw.storybismillah.database.remotekeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Story>): MediatorResult {
        ...
        wrapEspressoIdlingResource {
            try {
                val responseData = storyService.getAllStories(token, page, state.config.pageSize)
                ...
                database.withTransaction {
                    ...
                    responseData.listStory.forEach { storyResponse ->
                        ...
                        database.getstoryDao().insertStories(story)
                    }
                }
